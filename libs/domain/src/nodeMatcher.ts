...
export type ClickPhraseCandidate = {
...
export function matchClickPhraseToNode({
  phrase,
  candidates,
  nodes
}: {
  candidates: ClickPhraseCandidate[];
  ...
  const scored = candidates
    ...
    .filter(
      (
        ...
        candidate: ClickPhraseCandidate;
        node: FlipbookNode;
        score: number;
      } => match !== null
    )
