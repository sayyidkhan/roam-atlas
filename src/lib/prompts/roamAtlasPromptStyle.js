export const ROAMATLAS_PROMPT_VERSION = "roamatlas-flipbook-v5-brandless";
...
15. Never render app names, product logos, old product names, or brand-like decorative titles.
`;
